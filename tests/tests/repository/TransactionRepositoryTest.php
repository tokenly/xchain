...
class TransactionRepositoryTest extends TestCase {
    ...
    {
        $parsed_tx = $this->txHelper()->loadSampleTransaction('sample_xcp_parsed_01.json');
    ...
    {
        $parsed_tx = $this->txHelper()->loadSampleTransaction('sample_btc_parsed_01.json');
    ...
    // {
    //      $tx_repo = $this->app->make('App\Repositories\TransactionRepository');
    //      $raw_tx = $this->txHelper()->loadSampleTransaction('sample_btc_raw_01.json');
    //      // decode
